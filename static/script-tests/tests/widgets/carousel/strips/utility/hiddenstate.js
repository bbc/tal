...
(function () {
    ...
    this.HiddenStateTest.prototype.testAppendDoesNotCallRenderOnWidget = function (queue) {
        queuedApplicationInit(queue,
            ...
            function (application, HiddenState, WidgetContext, Widget, Device) {
                ...
                var state = this.createState(WidgetContext, HiddenState);
    ...
    this.HiddenStateTest.prototype.createState = function (Context, State) {
        this.sandbox.stub(Context.prototype);
        return new State();
    };

    this.HiddenStateTest.prototype.stubWidgetToReturnStubAppAndDevice = function (Widget, Device, application) {
