...
(function() {
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testSetSourceInitPlayerFailsReturningZero = function(queue) {
        var initPlayerReturnCode = 0;
        doTestSetSourceInitPlayerFailsStartPlybackNotCalled(this, queue, initPlayerReturnCode);
    };

    this.SamsungStreaming2015MediaPlayerTests.prototype.testSetSourceInitPlayerFailsReturningMinusOne = function(queue) {
        var initPlayerReturnCode = -1;
        doTestSetSourceInitPlayerFailsStartPlybackNotCalled(this, queue, initPlayerReturnCode);
    };

    this.SamsungStreaming2015MediaPlayerTests.prototype.testSetSourceInitPlayerFailsReturningFalse = function(queue) {
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testStartPlaybackCalledOnDeviceWhenBeginPlaybackFromCalledInStoppedState = function(queue) {
        expectAsserts(9);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
            assert(playerPlugin.Open.notCalled);
            assert(playerPlugin._methods.InitPlayer.notCalled);
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testPlayCalledOnDeviceWhenBeginPlaybackCalledInStoppedState = function(queue) {
        expectAsserts(8);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
            assert(playerPlugin.Open.notCalled);
            assert(playerPlugin._methods.InitPlayer.notCalled);
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testBeginPlaybackFromSetsCurrentTimeAndCallsPlayOnMediaElementWhenInStoppedState = function(queue) {
        expectAsserts(4);
        runMediaPlayerTest(this, queue, function (MediaPlayer) {
            this._mediaPlayer.setSource(MediaPlayer.TYPE.VIDEO, 'testURL', 'video/mp4');
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testResumePlayCalledWithTimePassedIntoBeginPlaybackFrom = function(queue) {
        expectAsserts(9);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
            assert(playerPlugin.Open.notCalled);
            assert(playerPlugin._methods.InitPlayer.notCalled);
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testPlayFromWhileBufferingDefersJumpUntilPlaying = function(queue) {
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testJumpOnDeviceWhenPlayFromCalledInInitialBufferingState = function(queue) {
        expectAsserts(10);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
            this._mediaPlayer.setSource(MediaPlayer.TYPE.VIDEO, 'testUrl', 'testMimeType');
            this._mediaPlayer.beginPlaybackFrom(0);
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testNoSecondBufferingEventWhenPlayingFromABufferingState = function(queue) {
        expectAsserts(3);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
    ...
    // PLAYING in response.
    this.SamsungStreaming2015MediaPlayerTests.prototype.testPlayFromCurrentTimeInPlayingStateBuffersThenPlays = function(queue) {
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testPlayFromNearAfterCurrentTimeInPlayingStateBuffersThenPlays = function(queue) {
        var initialTimeMs = 30000;
        var targetTimeSecs = 32.5;
        doTestPlayFromNearCurrentTimeInPlayingStateBuffersThenPlays(this, queue, initialTimeMs, targetTimeSecs);
    };

    this.SamsungStreaming2015MediaPlayerTests.prototype.testPlayFromNearBeforeCurrentTimeInPlayingStateBuffersThenPlays = function(queue) {
        var initialTimeMs = 30000;
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testPlayFromDifferentTimeWhenPlayingBuffersAndSeeks = function(queue) {
        expectAsserts(10);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
            this._mediaPlayer.setSource(MediaPlayer.TYPE.VIDEO, 'testUrl', 'testMimeType');
            this._mediaPlayer.beginPlaybackFrom(0);
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testPlayFromEarlierTimeWhenPlayingBuffersAndSeeks = function(queue) {
        expectAsserts(11);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
            this._mediaPlayer.setSource(MediaPlayer.TYPE.VIDEO, 'testUrl', 'testMimeType');
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testPlayFromEarlierTimeWhenPlayingThenPlayFromWhileBufferingSeeksAndPlays = function(queue) {
        expectAsserts(14);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
            this._mediaPlayer.setSource(MediaPlayer.TYPE.VIDEO, 'testUrl', 'testMimeType');
            this._mediaPlayer.beginPlaybackFrom(50);
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testPlayFromCurrentTimeWhenPausedBuffersThenPlays = function(queue) {
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testPlayFromNearAfterCurrentTimeWhenPausedBuffersThenPlays = function(queue) {
        var initialTimeMs = 50000;
        var targetTimeSecs = 52.5;
        doTestPlayFromNearCurrentTimeWhenPausedBuffersThenPlays(this, queue, initialTimeMs, targetTimeSecs);
    };

    this.SamsungStreaming2015MediaPlayerTests.prototype.testPlayFromNearBeforeCurrentTimeWhenPausedBuffersThenPlays = function(queue) {
        var initialTimeMs = 50000;
        var targetTimeSecs = 47.5;
        doTestPlayFromNearCurrentTimeWhenPausedBuffersThenPlays(this, queue, initialTimeMs, targetTimeSecs);
    };

    this.SamsungStreaming2015MediaPlayerTests.prototype.testPlayFromDifferentTimeWhenPausedBuffersAndSeeks = function(queue) {
        expectAsserts(10);
        var self = this;
        runMediaPlayerTest(self, queue, function(MediaPlayer) {
            self._mediaPlayer.setSource(MediaPlayer.TYPE.VIDEO, 'testUrl', 'testMimeType');
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testPlayFromDifferentTimeWhenPausedResumesAfterJump = function(queue) {
        expectAsserts(3);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
            this._mediaPlayer.setSource(MediaPlayer.TYPE.VIDEO, 'testUrl', 'testMimeType');
            this._mediaPlayer.beginPlaybackFrom(0);
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testPlayFromEarlierTimeWhenPausedBuffersAndSeeks = function(queue) {
        expectAsserts(11);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
            this._mediaPlayer.setSource(MediaPlayer.TYPE.VIDEO, 'testUrl', 'testMimeType');
            this._mediaPlayer.beginPlaybackFrom(50);
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testResumeWhenPausedCallsResume = function(queue) {
        expectAsserts(3);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
            this._mediaPlayer.setSource(MediaPlayer.TYPE.VIDEO, 'testUrl', 'testMimeType');
            this._mediaPlayer.beginPlaybackFrom(0);
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testPauseCallsPauseWhenPlaying = function(queue) {
        expectAsserts(3);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
            this._mediaPlayer.setSource(MediaPlayer.TYPE.VIDEO, 'testUrl', 'testMimeType');
            this._mediaPlayer.beginPlaybackFrom(0);
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testStopCallsStopWhenPlaying = function(queue) {
        expectAsserts(3);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
            this._mediaPlayer.setSource(MediaPlayer.TYPE.VIDEO, 'testUrl', 'testMimeType');
            this._mediaPlayer.beginPlaybackFrom(0);
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testMediaStoppedOnTransitionToErrorState = function(queue) {
        expectAsserts(2);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
            this._mediaPlayer.setSource(MediaPlayer.TYPE.VIDEO, 'testURL', 'video/mp4');
            this._mediaPlayer.beginPlaybackFrom(0);
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testOnRenderErrorCausesErrorEvent = function(queue) {
        expectAsserts(4);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testOnConnectionFailedCausesErrorEvent = function(queue) {
        expectAsserts(4);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testOnNetworkDisconnectedCausesErrorEvent = function(queue) {
        expectAsserts(4);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testOnStreamNotFoundCausesErrorEvent = function(queue) {
        expectAsserts(4);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testOnAuthenticationFailedCausesErrorEvent = function(queue) {
        expectAsserts(4);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testPlayFromTimeGreaterThanDurationWhilstPlayingClampsToJustBeforeEnd = function(queue) {
        expectAsserts(3);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
            this._mediaPlayer.setSource(MediaPlayer.TYPE.VIDEO, 'testUrl', 'testMimeType');
            this._mediaPlayer.beginPlaybackFrom(0);
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testPlayFromTimeGreaterThanDurationWhilstMidStreamBufferingClampsToJustBeforeEnd = function(queue) {
        expectAsserts(3);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
            this._mediaPlayer.setSource(MediaPlayer.TYPE.VIDEO, 'testUrl', 'testMimeType');
            this._mediaPlayer.beginPlaybackFrom(0);
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testPlayFromTimeGreaterThanDurationWhilstInitialBufferingClampsToJustBeforeEnd = function(queue) {
        expectAsserts(4);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
            this._mediaPlayer.setSource(MediaPlayer.TYPE.VIDEO, 'testUrl', 'testMimeType');
            this._mediaPlayer.beginPlaybackFrom(0);
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testPlayFromTimeGreaterThanDurationWhilstPausedClampsToJustBeforeEnd = function(queue) {
        expectAsserts(3);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
            this._mediaPlayer.setSource(MediaPlayer.TYPE.VIDEO, 'testUrl', 'testMimeType');
            this._mediaPlayer.beginPlaybackFrom(0);
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testPlayFromTimeGreaterThanDurationWhilstCompleteClampsToJustBeforeEnd = function(queue) {
        expectAsserts(3);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
            this._mediaPlayer.setSource(MediaPlayer.TYPE.VIDEO, 'testUrl', 'testMimeType');
            this._mediaPlayer.beginPlaybackFrom(0);
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testPlayFromAfterMediaCompletedCallsStopBeforeResumePlay = function(queue) {
        expectAsserts(5);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
            this._mediaPlayer.setSource(MediaPlayer.TYPE.VIDEO, 'testUrl', 'testMimeType');
            this._mediaPlayer.beginPlaybackFrom(0);
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testPlayFromWhileAtNonZeroTimeGCausesRelativeJump = function(queue) {
        expectAsserts(4);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
            this._mediaPlayer.setSource(MediaPlayer.TYPE.VIDEO, 'testUrl', 'testMimeType');
            this._mediaPlayer.beginPlaybackFrom(0);
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testStatusMessageIncludesUpdatedTime = function(queue) {
        expectAsserts(4);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
            this._mediaPlayer.setSource(MediaPlayer.TYPE.VIDEO, 'testUrl', 'testMimeType');
            this._mediaPlayer.beginPlaybackFrom(0);
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testPausingBeforeMetaDataLoadsResultsInPausedStateWhenDeviceIsAbleToPauseAfterBuffering = function(queue) {
        expectAsserts(2);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
            this._mediaPlayer.setSource(MediaPlayer.TYPE.VIDEO, 'testUrl', 'testMimeType');
            this._mediaPlayer.beginPlaybackFrom(0);
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testPausingBeforeMetaDataLoadsRemainsInBufferingStateWhenDeviceIsUnableToPauseAfterBuffering = function(queue) {
        expectAsserts(1);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
            this._mediaPlayer.setSource(MediaPlayer.TYPE.VIDEO, 'testUrl', 'testMimeType');
            this._mediaPlayer.beginPlaybackFrom(0);
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testPausingBeforeMetaDataLoadsResultsInSecondAttemptToPauseAfterBufferingWhenInitialPauseFailsReturningZero = function(queue) {
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testPausingBeforeMetaDataLoadsResultsInSecondAttemptToPauseAfterBufferingWhenInitialPauseFailsReturningMinusOne = function(queue) {
        var pauseReturnCode = -1;
        doTestPausingBeforeMetaDataLoadsResultsInSecondAttemptToPauseAfterBufferingWhenInitialPauseFails(this, queue, pauseReturnCode);
    };

    this.SamsungStreaming2015MediaPlayerTests.prototype.testPausingBeforeMetaDataLoadsResultsInSecondAttemptToPauseAfterBufferingWhenInitialPauseFailsReturningFalse = function(queue) {
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testPausingBeforeMetaDataLoadsThenResumingWhileAttemptingToPauseResultsInPlayingState = function(queue) {
        expectAsserts(1);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
            this._mediaPlayer.setSource(MediaPlayer.TYPE.VIDEO, 'testUrl', 'testMimeType');
            this._mediaPlayer.beginPlaybackFrom(0);
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testPausingBeforeMetaDataLoadsResultsInPausedStateWhenPausedAfterMultipleAttempts = function(queue) {
        expectAsserts(4);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
            this._mediaPlayer.setSource(MediaPlayer.TYPE.VIDEO, 'testUrl', 'testMimeType');
            this._mediaPlayer.beginPlaybackFrom(0);
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testStatusEventsOnlyEmittedInPlayingState = function(queue) {
        expectAsserts(1);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
            this._mediaPlayer.setSource(MediaPlayer.TYPE.VIDEO, 'testUrl', 'testMimeType');
            this._mediaPlayer.beginPlaybackFrom(0);
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testPlayFromWhilePlayingBeforeFirstStatusEventDefersJumpAndJumpsByCorrectAmount = function(queue) {
        expectAsserts(4);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
            this._mediaPlayer.setSource(MediaPlayer.TYPE.VIDEO, 'testUrl', 'testMimeType');
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testPlayFromWhilePausedBeforeFirstStatusEventDefersJumpAndJumpsByCorrectAmount = function(queue) {
        expectAsserts(4);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
            this._mediaPlayer.setSource(MediaPlayer.TYPE.VIDEO, 'testUrl', 'testMimeType');
            this._mediaPlayer.beginPlaybackFrom(30);
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testMediaPlayerIsStoppedOnAppHide = function(queue) {
        expectAsserts(3);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testMediaPlayerIsStoppedOnAppUnload = function(queue) {
        expectAsserts(3);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testMediaPlayerIgnorePeriodicRenderingCompleteEventInCompleteState = function (queue) {
        expectAsserts(4);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
            this._mediaPlayer.setSource(MediaPlayer.TYPE.VIDEO, 'testUrl', 'testMimeType');
            this._mediaPlayer.beginPlayback();
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testPluginCloseCalledOnReset = function(queue) {
        expectAsserts(6);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
            assert(playerPlugin.Open.notCalled);            
            this._mediaPlayer.setSource(MediaPlayer.TYPE.VIDEO, 'testUrl', 'testMimeType');
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testPluginCloseNotCalledAfterStopCalledThenStartPlayback = function(queue) {
        expectAsserts(7);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
            assert(playerPlugin.Open.notCalled);            
            this._mediaPlayer.setSource(MediaPlayer.TYPE.VIDEO, 'testUrl', 'testMimeType');
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testWindowHideEventListenerIsTornDownOnReset = function(queue) {
        expectAsserts(4);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testWindowUnloadEventListenerIsTornDownOnReset = function(queue) {
        expectAsserts(4);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testCurrentTimeIsUpdatedByOnCurrentPlayTimeEvents = function(queue) {
        expectAsserts(4);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
            this._mediaPlayer.setSource(MediaPlayer.TYPE.VIDEO, 'testUrl', 'testMimeType');
            this._mediaPlayer.beginPlaybackFrom(0);
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testFailedJumpReturningZeroWhilePlayingReturnsToPlayingState = function(queue) {
        var jumpReturnCode = 0;
        doTestFailedJumpWhilePlayingReturnsToPlayingState(this, queue, jumpReturnCode);
    };

    this.SamsungStreaming2015MediaPlayerTests.prototype.testFailedJumpReturningMinusOneWhilePlayingReturnsToPlayingState = function(queue) {
        var jumpReturnCode = -1;
        doTestFailedJumpWhilePlayingReturnsToPlayingState(this, queue, jumpReturnCode);
    };

    this.SamsungStreaming2015MediaPlayerTests.prototype.testFailedJumpReturningFalseWhilePlayingReturnsToPlayingState = function(queue) {
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testFailedJumpReturningZeroWhilePausedGoesToPlayingState = function(queue) {
        var jumpReturnCode = 0;
        doTestFailedJumpWhilePausedReturnsToPlayingState(this, queue, jumpReturnCode);
    };

    this.SamsungStreaming2015MediaPlayerTests.prototype.testFailedJumpReturningMinusOneWhilePausedGoesToPlayingState = function(queue) {
        var jumpReturnCode = -1;
        doTestFailedJumpWhilePausedReturnsToPlayingState(this, queue, jumpReturnCode);
    };

    this.SamsungStreaming2015MediaPlayerTests.prototype.testFailedJumpReturningFalseWhilePausedGoesToPlayingState = function(queue) {
        var jumpReturnCode = false;
        doTestFailedJumpWhilePausedReturnsToPlayingState(this, queue, jumpReturnCode);
    };
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testFailedDeferredJumpRemainsInBufferingState = function(queue) {
        expectAsserts(5);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
            this._mediaPlayer.setSource(MediaPlayer.TYPE.VIDEO, 'testUrl', 'testMimeType');
            this._mediaPlayer.beginPlaybackFrom(0);
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testFailedDeferredJumpResultsInRepeatedAttemptsToJumpUntilSuccess = function(queue) {
        expectAsserts(8);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
            this._mediaPlayer.setSource(MediaPlayer.TYPE.VIDEO, 'testUrl', 'testMimeType');
            this._mediaPlayer.beginPlaybackFrom(0);
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testDeferredJumpsDoNotReenterBufferingState = function(queue) {
        expectAsserts(3);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
            this._mediaPlayer.setSource(MediaPlayer.TYPE.VIDEO, 'testUrl', 'testMimeType');
            this._mediaPlayer.beginPlaybackFrom(0);
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testDeferredSeekIsCancelledWhenTargetIsCurrentTime = function(queue) {
        var targetTime = 30;
        doTestDeferredSeekIsCancelledWhenTargetIsNearCurrentTime(this, queue, targetTime);
    };

    this.SamsungStreaming2015MediaPlayerTests.prototype.testDeferredSeekIsCancelledWhenTargetIsNearAfterCurrentTime = function(queue) {
        var targetTime = 32.5;
        doTestDeferredSeekIsCancelledWhenTargetIsNearCurrentTime(this, queue, targetTime);
    };

    this.SamsungStreaming2015MediaPlayerTests.prototype.testDeferredSeekIsCancelledWhenTargetIsNearBeforeCurrentTime = function(queue) {
        var targetTime = 27.5;
        doTestDeferredSeekIsCancelledWhenTargetIsNearCurrentTime(this, queue, targetTime);
    };
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testPlayFromAndPauseBeforeMetaDataLoadsResultsInSeekFirstThenPauseWithCurrentTime = function(queue) {
        expectAsserts(5);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
            this._mediaPlayer.setSource(MediaPlayer.TYPE.VIDEO, 'testUrl', 'testMimeType');
            this._mediaPlayer.beginPlaybackFrom(0);
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testDeferredSeekDoesNotPersistAfterReset = function(queue) {
        expectAsserts(1);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
            this._mediaPlayer.setSource(MediaPlayer.TYPE.VIDEO, 'testUrl', 'testMimeType');
            this._mediaPlayer.beginPlaybackFrom(0);
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testDeferredPauseDoesNotPersistAfterReset = function(queue) {
        expectAsserts(2);
        playerPlugin._methods.Pause.returns(0);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
            this._mediaPlayer.setSource(MediaPlayer.TYPE.VIDEO, 'testUrl', 'testMimeType');
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testMediaUrlGetsSpecialHlsFragmentAppended = function(queue) {
        expectAsserts(1);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testMediaUrlGetsSpecialHlsFragmentAppendedWithXMpegUrl = function(queue) {
        expectAsserts(1);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testGetSourceDoesNotHaveSpecialHlsFragmentAppended = function(queue) {
        expectAsserts(1);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testCallingStopFromStoppedStateDoesNotCallDeviceStop = function(queue) {
        expectAsserts(1);
        runMediaPlayerTest(this, queue, function (MediaPlayer) {
    ...
    this.SamsungStreaming2015MediaPlayerTests.prototype.testGetPlayerElement = function(queue) {
        expectAsserts(1);
        runMediaPlayerTest(this, queue, function (MediaPlayer) {
            this._mediaPlayer.setSource(MediaPlayer.TYPE.VIDEO, 'testURL', 'video/mp4');
