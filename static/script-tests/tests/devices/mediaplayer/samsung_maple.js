...
(function() {
    ...
    this.SamsungMapleMediaPlayerTests.prototype.testSamsungMapleListenerFunctionsAddedDuringInitialiseMedia = function(queue) {
    ...
    this.SamsungMapleMediaPlayerTests.prototype.testSamsungMapleListenerFunctionsReferencedOnObjectDuringInitialiseMedia = function(queue) {
        expectAsserts(listenerFunctions.length * 2);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
    ...
    var doTestPlayFromNearCurrentTimeInPlayingStateBuffersThenPlays = function(self, queue, initialTimeMs, targetTimeSecs) {
        ...
        runMediaPlayerTest(self, queue, function(MediaPlayer) {
            self._mediaPlayer.initialiseMedia(MediaPlayer.TYPE.VIDEO, 'testUrl', 'testMimeType', sourceContainer);
    ...
    this.SamsungMapleMediaPlayerTests.prototype.testPlayFromAndPauseBeforeMetaDataLoadsResultsInSeekFirstThenPauseWithCurrentTime = function(queue) {
        expectAsserts(5);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
            this._mediaPlayer.initialiseMedia(MediaPlayer.TYPE.VIDEO, 'testUrl', 'audio/mp4', sourceContainer);
            this._mediaPlayer.beginPlaybackFrom(0);
            this._mediaPlayer.playFrom(30);
            this._mediaPlayer.pause();
    ...
    this.SamsungMapleMediaPlayerTests.prototype.testMediaUrlGetsSpecialHlsFragmentAppended = function(queue) {
        expectAsserts(1);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
            this._mediaPlayer.initialiseMedia(MediaPlayer.TYPE.VIDEO, 'test/url', 'application/vnd.apple.mpegurl', sourceContainer);
            this._mediaPlayer.beginPlaybackFrom(0);
            deviceMockingHooks.sendMetadata(this._mediaPlayer, 0, { start: 0, end: 60 });
            deviceMockingHooks.finishBuffering(this._mediaPlayer);
    ...
    this.SamsungMapleMediaPlayerTests.prototype.testMediaUrlGetsSpecialHlsFragmentAppendedWithXMpegUrl = function(queue) {
        expectAsserts(1);
        runMediaPlayerTest(this, queue, function(MediaPlayer) {
            this._mediaPlayer.initialiseMedia(MediaPlayer.TYPE.VIDEO, 'test/url', 'application/x-mpegURL', sourceContainer);
            this._mediaPlayer.beginPlaybackFrom(0);
            deviceMockingHooks.sendMetadata(this._mediaPlayer, 0, { start: 0, end: 60 });
            deviceMockingHooks.finishBuffering(this._mediaPlayer);
            assert(playerPlugin.ResumePlay.calledWith('test/url|COMPONENT=HLS', 0));
