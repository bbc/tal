...
(function() {
	...
	this.XHRThisWindowNetworkTest.prototype.testLoadScriptWithTimedOutResponse = function(queue) {
		expectAsserts(2);
	...
	this.XHRThisWindowNetworkTest.prototype.testLoadScriptWithDefaultFiveSecondTimedOutResponse = function(queue) {
		expectAsserts(2);
	...
	this.XHRThisWindowNetworkTest.prototype.testLoadScriptWithSuccessResponse = function(queue) {
		expectAsserts(6);
	...
	this.XHRThisWindowNetworkTest.prototype.testLoadScriptMultipleRequestsWithDifferentSuffixes = function(queue) {
		expectAsserts(11);
	...
	this.XHRThisWindowNetworkTest.prototype.testLoadScriptMultipleRequestsWithSameSuffixThrowsError = function(queue) {
		expectAsserts(2);
	...
	this.XHRThisWindowNetworkTest.prototype.testLoadScriptSequentialRequestsWithSameSuffixAreAllowed = function(queue) {
		expectAsserts(13);
	...
	this.XHRThisWindowNetworkTest.prototype.testLoadScriptSubsequentRequestWithSameSuffixIsAllowedAfterTimeout = function(queue) {
		expectAsserts(9);
	...
	this.XHRThisWindowNetworkTest.prototype.testCrossDomainPost = function(queue) {
		expectAsserts(35);
	...
	this.XHRThisWindowNetworkTest.prototype.testExecuteCrossDomainGetDelegatesToLoadScriptWhenCorsIsNotSupported = function(queue) {
		queuedApplicationInit(queue, "lib/mockapplication", ["antie/devices/browserdevice"], function(application, BrowserDevice) {
    ...
    this.XHRThisWindowNetworkTest.prototype.testExecuteCrossDomainDelegationToLoadScriptWhenCorsIsNotSupportedAllowsCallbackNameChange = function(queue) {
        queuedApplicationInit(queue, "lib/mockapplication", ["antie/devices/browserdevice"], function(application, BrowserDevice) {
            var device = new BrowserDevice({"networking": { "supportsCORS": false }});
            var testUrl = "http://test";
    ...
    this.XHRThisWindowNetworkTest.prototype.testExecuteCrossDomainDelegationToLoadScriptWhenCorsIsNotSupportedRespectsExistingQueryParameters = function(queue) {
        queuedApplicationInit(queue, "lib/mockapplication", ["antie/devices/browserdevice"], function(application, BrowserDevice) {
            var device = new BrowserDevice({"networking": { "supportsCORS": false }});
	...
	this.XHRThisWindowNetworkTest.prototype.testExecuteCrossDomainPostCallsLoadUrlWithJsonPayloadWhenCorsIsSupported = function(queue) {
		queuedApplicationInit(queue, "lib/mockapplication", ["antie/devices/browserdevice"], function(application, BrowserDevice) {
			var device = new BrowserDevice({"networking": { "supportsCORS": true }});
	...
	this.XHRThisWindowNetworkTest.prototype.testExecuteCrossDomainPostCallsCrossDomainPostWhenCorsIsNotSupported = function(queue) {
		queuedApplicationInit(queue, "lib/mockapplication", ["antie/devices/browserdevice"], function(application, BrowserDevice) {
			var device = new BrowserDevice({"networking": { "supportsCORS": false }});
	...
	this.XHRThisWindowNetworkTest.prototype.testExecuteCrossDomainPostCallsCrossDomainPostWithaCustomIframeWhenCorsIsNotSupported = function(queue) {
		queuedApplicationInit(queue, "lib/mockapplication", ["antie/devices/browserdevice"], function(application, BrowserDevice) {
			var device = new BrowserDevice({"networking": { "supportsCORS": false }});
