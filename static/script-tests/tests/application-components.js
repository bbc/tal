    ...
    this.ApplicationComponentsTest.prototype.testSetGetRootWidget = function(queue) {
        ...
        queuedApplicationInit(
            ...
            function(application, Container) {
                ...
                assertException('Passing a non-widget causes an exception', function() {
                    application.setRootWidget('TEST');
                });

                var container = new Container();
                assertNoException('Passing a widget causes no exception', function() {
                    application.setRootWidget(container);
                });
