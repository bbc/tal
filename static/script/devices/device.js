...
require.def('antie/devices/device',
	...
	function(Class, KeyEvent, StorageProvider, SessionStorage, require) {
		/**
		 * Abstract base class for Bigscreen devices.
		 ...
		 *
		 * Any of the methods below can be overriden by a device-specific subclass or implmenetation common to multiple
		...
		var Device = Class.extend(/** @lends antie.devices.Device.prototype */ {
			 ...
			 */
			scrollElementTo: function(el, left, top, skipAnim, onComplete) {
			},
			/**
			 ...
			 */
			moveElementTo: function(el, left, top, skipAnim, onComplete) {
			},
			/**
			 * Hides an element.
			 ...
			 */
			hideElement: function(el, skipAnim, onComplete) {
			},
			/**
			 * Shows an element.
