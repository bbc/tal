		...
		var HTML5Player = Media.extend({
			...
			*/
			...
			destroy: function() {
				...
				var sourceElements = this._mediaElement.getElementsByTagName("source");
				for(var sourceElementIndex = 0; sourceElementIndex < sourceElements.length; sourceElementIndex++) {
				...
				// Trick to abort browser loading threads (e.g. Chrome)
				// Disabled BSCREEN-959 due to causing issues with certain devices
